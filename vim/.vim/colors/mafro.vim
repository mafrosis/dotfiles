" ==============================================================================
"   Name:        mafro (based on One Half Dark)
...
let g:colors_name="mafro"
let colors_name="mafro"


let s:black       = { "gui": "black", "cterm": "black" }
let s:red         = { "gui": "#e06c75", "cterm": "168" }
let s:green       = { "gui": "#98c379", "cterm": "114" }
let s:yellow      = { "gui": "#e5c07b", "cterm": "180" }
let s:blue        = { "gui": "#61afef", "cterm": "51"  }
let s:purple      = { "gui": "#c678dd", "cterm": "176" }
let s:cyan        = { "gui": "#96cbfe", "cterm": "33"  }
let s:white       = { "gui": "#dcdfe4", "cterm": "188" }
let s:brown       = { "gui": "#a56221", "cterm": "130" }
let s:error       = { "gui": "#ff6c60", "cterm": "196" }

let s:fg          = s:white
let s:bg          = s:black

let s:comment_fg  = { "gui": "#5c6370", "cterm": "241" }
let s:gutter_bg   = { "gui": "black", "cterm": "black" }
let s:gutter_fg   = { "gui": "#414141", "cterm": "247" }
...
call s:h("ErrorMsg", s:white, s:error, "")
...
call s:h("SpellBad", s:white, s:error, "")
...
call s:h("Special", s:white, "", "")
call s:h("SpecialChar", s:cyan, "", "")
call s:h("Tag", s:fg, "", "")
...
call s:h("Error", s:white, s:error, "")
call s:h("Todo", s:black, s:error, "")
" }
