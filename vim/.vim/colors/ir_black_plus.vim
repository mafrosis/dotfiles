" ir_black_plus color scheme
" 
" Based on ir_black from;
" 	http://blog.infinitered.com/entries/show/8

" TODO: Add support for simple console
" ********************************************************************************
set background=dark
hi clear
...
" Tabline - This only really matters for non-gui
hi TabLineSel														ctermfg=NONE		ctermbg=darkgray	cterm=BOLD
hi TabLine															ctermfg=black		ctermbg=darkgray	cterm=NONE
hi TabLineFill														ctermfg=black		ctermbg=NONE		cterm=NONE
" Message displayed in lower left, such as --INSERT--
hi ModeMsg			guifg=black		guibg=#C6C5FE	gui=BOLD		ctermfg=black		ctermbg=cyan		cterm=NONE
...
if version >= 700 " Vim 7.x specific colors
  ...
  hi Search			guifg=black		guibg=#ffffcc	gui=NONE		ctermfg=black		ctermbg=yellow		cterm=none
endif
...
hi Todo				guifg=#eeeeee	guibg=#ff3333	gui=NONE		ctermfg=black		ctermbg=red			cterm=NONE
